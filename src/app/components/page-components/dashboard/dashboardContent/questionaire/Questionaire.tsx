  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.questionairebtn}>
        <button className={styles.questionbtn1}>Resume Questionnaire</button>
        <button className={styles.questionbtn2}>Start New Questionnaire <GoArrowRight className={styles.btnIcon}/></button>
      </div>
      {openQuestionaire && (
